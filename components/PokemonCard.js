...
function Pokemon({ name, id, url, types, image }) {
  ...
  return (
    <Link href={`/${name}`}>
      <div
        className="relative flex aspect-square w-32 cursor-pointer flex-col overflow-hidden rounded-xl bg-white transition hover:scale-105 hover:border-2 sm:w-40"
